...
public class CdbPreTest extends AppCompatActivity implements RadioButton.OnCheckedChangeListener, View.OnClickListener {
    ...
    void value_assignment() {
        ...
        if (rb_cdbpretestq5a2.isChecked()) {
            cdbpretestq5 = "2";
        }
        if (rb_cdbpretestq5a3.isChecked()) {
            cdbpretestq5 = "3";
            temp = temp + 1;
        }
        if (rb_cdbpretestq5a4.isChecked()) {
            cdbpretestq5 = "4";
        }
        ...
        if (rb_cdbpretestq6a2.isChecked()) {
            cdbpretestq6 = "2";
        }
        if (rb_cdbpretestq6a3.isChecked()) {
            cdbpretestq6 = "3";
            temp = temp + 1;
        }
        if (rb_cdbpretestq6a4.isChecked()) {
            cdbpretestq6 = "4";
        }

        //Q7
        if (rb_cdbpretestq7a1.isChecked()) {
            cdbpretestq7 = "1";
            temp = temp + 1;
        }
        if (rb_cdbpretestq7a2.isChecked()) {
            cdbpretestq7 = "2";
        }
        if (rb_cdbpretestq7a3.isChecked()) {
            cdbpretestq7 = "3";
        }
        if (rb_cdbpretestq7a4.isChecked()) {
            cdbpretestq7 = "4";
        }
        ...
        if (rb_cdbpretestq8a2.isChecked()) {
            cdbpretestq8 = "2";
        }
        if (rb_cdbpretestq8a3.isChecked()) {
            cdbpretestq8 = "3";
        }
        if (rb_cdbpretestq8a4.isChecked()) {
            cdbpretestq8 = "4";
        }

        //Q9
        if (rb_cdbpretestq9a1.isChecked()) {
            cdbpretestq9 = "1";
        }
        if (rb_cdbpretestq9a2.isChecked()) {
            cdbpretestq9 = "2";
        }
        if (rb_cdbpretestq9a3.isChecked()) {
            cdbpretestq9 = "3";
        }
        if (rb_cdbpretestq9a4.isChecked()) {
            cdbpretestq9 = "4";
            temp = temp + 1;
        }

        //Q10
        if (rb_cdbpretestq10a1.isChecked()) {
            cdbpretestq10 = "1";
        }
        if (rb_cdbpretestq10a2.isChecked()) {
            cdbpretestq10 = "2";
        }
        if (rb_cdbpretestq10a3.isChecked()) {
            cdbpretestq10 = "3";
        }
        if (rb_cdbpretestq10a4.isChecked()) {
            cdbpretestq10 = "4";
            temp = temp + 1;
        }
