...
public class DiarrheaPreTest extends AppCompatActivity implements RadioButton.OnCheckedChangeListener, View.OnClickListener {
    ...
    void value_assignment() {
        ...
        //Q6
        diarrheapretestq6 = rb_diarrheapretestq6a1.isChecked() ? "1"
                : rb_diarrheapretestq6a2.isChecked() ? "2"
                : rb_diarrheapretestq6a3.isChecked() ? "3"
                : rb_diarrheapretestq6a4.isChecked() ? "4"
                : "-1";
        ...
        //Q8
        diarrheapretestq8 = rb_diarrheapretestq8a1.isChecked() ? "1"
                : rb_diarrheapretestq8a2.isChecked() ? "2"
                : rb_diarrheapretestq8a3.isChecked() ? "3"
                : rb_diarrheapretestq8a4.isChecked() ? "4"
                : "-1";
        temp = diarrheapretestq8.equals("2") ? temp + 2 : temp;

        //Q9
        diarrheapretestq9 = rb_diarrheapretestq9a1.isChecked() ? "1"
                : rb_diarrheapretestq9a2.isChecked() ? "2"
                : rb_diarrheapretestq9a3.isChecked() ? "3"
                : rb_diarrheapretestq9a4.isChecked() ? "4"
                : "-1";
        temp = diarrheapretestq9.equals("2") ? temp + 2 : temp;

        //Q10
        diarrheapretestq10 = rb_diarrheapretestq10a1.isChecked() ? "1"
                : rb_diarrheapretestq10a2.isChecked() ? "2"
                : rb_diarrheapretestq10a3.isChecked() ? "3"
                : rb_diarrheapretestq10a4.isChecked() ? "4"
                : "-1";
        temp = diarrheapretestq10.equals("4") ? temp + 2 : temp;
