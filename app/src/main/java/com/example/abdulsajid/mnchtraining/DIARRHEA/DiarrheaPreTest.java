...
public class DiarrheaPreTest extends AppCompatActivity implements RadioButton.OnCheckedChangeListener, View.OnClickListener {
    ...
    void value_assignment() {
        ...
        if (rb_diarrheapretestq1a2.isChecked()) {
            diarrheapretestq1 = "2";
        }
        if (rb_diarrheapretestq1a3.isChecked()) {
            diarrheapretestq1 = "3";
        }
        if (rb_diarrheapretestq1a4.isChecked()) {
            diarrheapretestq1 = "4";
        }
        ...
        if (rb_diarrheapretestq4a2.isChecked()) {
            diarrheapretestq4 = "2";
            temp = temp + 1;
        }
        if (rb_diarrheapretestq4a3.isChecked()) {
            diarrheapretestq4 = "3";
        }
        if (rb_diarrheapretestq4a4.isChecked()) {
            diarrheapretestq4 = "4";
        }

        //Q5
        if (rb_diarrheapretestq5a1.isChecked()) {
            diarrheapretestq5 = "1";
        }
        if (rb_diarrheapretestq5a2.isChecked()) {
            diarrheapretestq5 = "2";
        }
        if (rb_diarrheapretestq5a3.isChecked()) {
            diarrheapretestq5 = "3";
        }
        if (rb_diarrheapretestq5a4.isChecked()) {
            diarrheapretestq5 = "4";
            temp = temp + 1;
        }
