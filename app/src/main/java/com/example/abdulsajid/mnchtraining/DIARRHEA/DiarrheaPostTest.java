...
public class DiarrheaPostTest extends AppCompatActivity implements RadioButton.OnCheckedChangeListener, View.OnClickListener {
    ...
    void value_assignment() {
        ...
        //Q2
        diarrheaposttestq2 = rb_diarrheaposttestq2a1.isChecked() ? "1"
                : rb_diarrheaposttestq2a2.isChecked() ? "2"
                : rb_diarrheaposttestq2a3.isChecked() ? "3"
                : rb_diarrheaposttestq2a4.isChecked() ? "4"
                : "-1";
        temp = diarrheaposttestq2.equals("1") ? temp + 1 : temp;

        //Q3
        diarrheaposttestq3 = rb_diarrheaposttestq3a1.isChecked() ? "1"
                : rb_diarrheaposttestq3a2.isChecked() ? "2"
                : rb_diarrheaposttestq3a3.isChecked() ? "3"
                : rb_diarrheaposttestq3a4.isChecked() ? "4"
                : "-1";
        temp = diarrheaposttestq3.equals("1") ? temp + 1 : temp;

        //Q4
        diarrheaposttestq4 = rb_diarrheaposttestq4a1.isChecked() ? "1"
                : rb_diarrheaposttestq4a2.isChecked() ? "2"
                : rb_diarrheaposttestq4a3.isChecked() ? "3"
                : rb_diarrheaposttestq4a4.isChecked() ? "4"
                : "-1";
        temp = diarrheaposttestq4.equals("2") ? temp + 1 : temp;

        //Q5
        diarrheaposttestq5 = rb_diarrheaposttestq5a1.isChecked() ? "1"
                : rb_diarrheaposttestq5a2.isChecked() ? "2"
                : rb_diarrheaposttestq5a3.isChecked() ? "3"
                : rb_diarrheaposttestq5a4.isChecked() ? "4"
                : "-1";
        temp = diarrheaposttestq5.equals("4") ? temp + 1 : temp;

        //Q6
        diarrheaposttestq6 = rb_diarrheaposttestq6a1.isChecked() ? "1"
                : rb_diarrheaposttestq6a2.isChecked() ? "2"
                : rb_diarrheaposttestq6a3.isChecked() ? "3"
                : rb_diarrheaposttestq6a4.isChecked() ? "4"
                : "-1";
        temp = diarrheaposttestq6.equals("2") ? temp + 1 : temp;

        //Q7
        diarrheaposttestq7 = rb_diarrheaposttestq7a1.isChecked() ? "1"
                : rb_diarrheaposttestq7a2.isChecked() ? "2"
                : rb_diarrheaposttestq7a3.isChecked() ? "3"
                : rb_diarrheaposttestq7a4.isChecked() ? "4"
                : "-1";
        temp = diarrheaposttestq7.equals("1") ? temp + 1 : temp;

        //Q8
        diarrheaposttestq8 = rb_diarrheaposttestq8a1.isChecked() ? "1"
                : rb_diarrheaposttestq8a2.isChecked() ? "2"
                : rb_diarrheaposttestq8a3.isChecked() ? "3"
                : rb_diarrheaposttestq8a4.isChecked() ? "4"
                : "-1";
        temp = diarrheaposttestq8.equals("2") ? temp + 1 : temp;

        //Q9
        diarrheaposttestq9 = rb_diarrheaposttestq9a1.isChecked() ? "1"
                : rb_diarrheaposttestq9a2.isChecked() ? "2"
                : rb_diarrheaposttestq9a3.isChecked() ? "3"
                : rb_diarrheaposttestq9a4.isChecked() ? "4"
                : "-1";
        temp = diarrheaposttestq9.equals("2") ? temp + 1 : temp;

        //Q10
        diarrheaposttestq10 = rb_diarrheaposttestq10a1.isChecked() ? "1"
                : rb_diarrheaposttestq10a2.isChecked() ? "2"
                : rb_diarrheaposttestq10a3.isChecked() ? "3"
                : rb_diarrheaposttestq10a4.isChecked() ? "4"
                : "-1";
        temp = diarrheaposttestq10.equals("4") ? temp + 1 : temp;
