...
public class GdsPostTest extends AppCompatActivity implements RadioButton.OnCheckedChangeListener, View.OnClickListener {
    ...
    void value_assignment() {
        ...
        //Q5
        gdsposttestq5 = rb_gdsposttestq5a1.isChecked() ? "1"
                : rb_gdsposttestq5a2.isChecked() ? "2"
                : rb_gdsposttestq5a3.isChecked() ? "3"
                : rb_gdsposttestq5a4.isChecked() ? "4"
                : "-1";
        temp = gdsposttestq5.equals("4") ? temp + 1 : temp;

        //Q6
        gdsposttestq6 = rb_gdsposttestq6a1.isChecked() ? "1"
                : rb_gdsposttestq6a2.isChecked() ? "2"
                : "-1";
        temp = gdsposttestq6.equals("2") ? temp + 1 : temp;

        //Q7
        gdsposttestq7 = rb_gdsposttestq7a1.isChecked() ? "1"
                : rb_gdsposttestq7a2.isChecked() ? "2"
                : rb_gdsposttestq7a3.isChecked() ? "3"
                : rb_gdsposttestq7a4.isChecked() ? "4"
                : "-1";
        temp = gdsposttestq7.equals("3") ? temp + 1 : temp;

        //Q8
        gdsposttestq8 = rb_gdsposttestq8a1.isChecked() ? "1"
                : rb_gdsposttestq8a2.isChecked() ? "2"
                : rb_gdsposttestq8a3.isChecked() ? "3"
                : rb_gdsposttestq8a4.isChecked() ? "4"
                : "-1";
        temp = gdsposttestq8.equals("2") ? temp + 1 : temp;

        //Q9
        gdsposttestq9 = rb_gdsposttestq9a1.isChecked() ? "1"
                : rb_gdsposttestq9a2.isChecked() ? "2"
                : rb_gdsposttestq9a3.isChecked() ? "3"
                : rb_gdsposttestq9a4.isChecked() ? "4"
                : "-1";
        temp = gdsposttestq9.equals("1") ? temp + 1 : temp;

        //Q10
        gdsposttestq10 = rb_gdsposttestq10a1.isChecked() ? "1"
                : rb_gdsposttestq10a2.isChecked() ? "2"
                : rb_gdsposttestq10a3.isChecked() ? "3"
                : rb_gdsposttestq10a4.isChecked() ? "4"
                : "-1";
        temp = gdsposttestq10.equals("3") ? temp + 1 : temp;
