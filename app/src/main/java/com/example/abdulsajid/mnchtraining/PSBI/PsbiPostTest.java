...
public class PsbiPostTest extends AppCompatActivity implements RadioButton.OnCheckedChangeListener, View.OnClickListener {
    ...
    void value_assignment() {
        ...
        if (rb_psbiposttestq2a2.isChecked()) {
            psbiposttestq2 = "2";
        }
        if (rb_psbiposttestq2a3.isChecked()) {
            psbiposttestq2 = "3";
            temp = temp + 1;
        }
        if (rb_psbiposttestq2a4.isChecked()) {
            psbiposttestq2 = "4";
        }
        ...
        if (rb_psbiposttestq4a2.isChecked()) {
            psbiposttestq4 = "2";
        }
        if (rb_psbiposttestq4a3.isChecked()) {
            psbiposttestq4 = "3";
        }
        if (rb_psbiposttestq4a4.isChecked()) {
            psbiposttestq4 = "4";
        }
        ...
        if (rb_psbiposttestq7a2.isChecked()) {
            psbiposttestq7 = "2";
        }
        if (rb_psbiposttestq7a3.isChecked()) {
            psbiposttestq7 = "3";
            temp = temp + 1;
        }
        if (rb_psbiposttestq7a4.isChecked()) {
            psbiposttestq7 = "4";
        }
